package nl.knikit.card.service.marvel;
...
import nl.knikit.card.configuration.MarvelServiceProperties;
import nl.knikit.card.domain.Character;
import nl.knikit.card.domain.Serie;
import nl.knikit.card.util.MD5Util;
...
public class MarvelService {
    ...
    public List<Character> getAllCharacters(int limit) throws IOException {
        ...
        log.info("Hash used for Marvel " + hash + " ,uri is ", uriComponents.toString());
