...
@Slf4j
@Component
public class ProgressCardMovesForTurnTrigger implements Action<ProgressCardMovesForTurnTrigger.ProgressCardMovesForTurnTriggerDTO, EventOutput.Result> {

    @Resource
    VisitorRepository visitorRepository;

    @Override
    public EventOutput.Result perform(ProgressCardMovesForTurnTriggerDTO actionDto) {
    ...
    void setErrorMessageConflict(ProgressCardMovesForTurnTriggerDTO actionDto, String id,
                                 String value) {
    ...
    private void setErrorMessageBadRequest(ProgressCardMovesForTurnTriggerDTO actionDto, String id,
                                           String value) {
    ...
    public interface ProgressCardMovesForTurnTriggerDTO {
