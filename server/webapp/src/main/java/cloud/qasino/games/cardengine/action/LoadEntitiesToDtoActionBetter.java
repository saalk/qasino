 ...
 */
public class LoadEntitiesToDtoActionBetter implements Action<QasinoFlowDtoBetter, EventOutput.Result> {
    ...
    @Override
    public EventOutput.Result perform(final QasinoFlowDtoBetter dto) {
...
//    }
    ...
    public EventOutput failure(QasinoFlowDtoBetter actionDto) {
    ...
    public EventOutput success(QasinoFlowDtoBetter actionDto) {
        return new EventOutput(EventOutput.Result.FAILURE, actionDto.getIds().getSuppliedGameEvent(), actionDto.getIds().getSuppliedTurnEvent());
    }

    private void setNotFoundErrorMessage(QasinoFlowDtoBetter actionDto, String id, String value, String entity) {
        actionDto.getMessage().setErrorKey(id);
        actionDto.getMessage().setErrorValue(value);
        actionDto.getMessage().setNotFoundErrorMessage("[" + entity + "] not found for id [" + value + "]");
