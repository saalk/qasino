...
@Slf4j
@Component
public class IsTurnConsistentForGameTrigger implements Action<IsTurnConsistentForGameTrigger.IsTurnConsistentForGameTriggerDTO, EventOutput.Result> {

    @Resource
    VisitorRepository visitorRepository;

    @Override
    public EventOutput.Result perform(IsTurnConsistentForGameTriggerDTO actionDto) {
    ...
    void setErrorMessageConflict(IsTurnConsistentForGameTriggerDTO actionDto, String id,
                                 String value) {
    ...
    private void setErrorMessageBadRequest(IsTurnConsistentForGameTriggerDTO actionDto, String id,
                                           String value) {
    ...
    public interface IsTurnConsistentForGameTriggerDTO {
