...
"bet" integer, "end_fiches" integer,
"start_fiches" integer, "card_id" bigint,
"player_id" bigint, "turn_id" bigint,
"created" varchar(25),
...
"sequence" varchar(255), primary key ("cardmove_id")
);
create table "game" (
"ante" integer,
...
"created" varchar(25),
"ended" varchar(25),
"name" varchar(50) not null, primary key ("league_id")
);
create table "player" (
"fiches" integer,
"is_human" boolean,
