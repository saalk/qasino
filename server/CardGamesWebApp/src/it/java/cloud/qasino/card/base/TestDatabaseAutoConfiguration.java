...
import cloud.qasino.card.database.configuration.DatabaseAutoConfiguration;
import cloud.qasino.card.database.configuration.DatabaseProperties;
...
public class TestDatabaseAutoConfiguration extends DatabaseAutoConfiguration {
    ...
    public TestDatabaseAutoConfiguration(DatabaseProperties databaseProperties, MeterRegistry meterRegistry) {
...
//        super(databaseProperties, meterRegistry);
    ...
    public DataSource dataSource() {
        log.warn("Datasource for in-memory database");
