...

{
    ...
    private List<Quiz> suppliedQuizs;   // todo
    ...
    private List<Quiz> qasinoGameQuizs;
    private List<QuizMove> qasinoGameQuizMoves;
    ...
    public boolean balanceNotZero;      // icon is quizzes -> select/start game to enable nav-game
