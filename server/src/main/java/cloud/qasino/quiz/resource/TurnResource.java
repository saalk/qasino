...
import cloud.qasino.quiz.repository.TurnRepository;
...
public class TurnResource {
    ...
    // TurnResource - special POST for GAME, PLAYINGQUIZ, EVENT and RESULT has state machine
    ...
    public ResponseEntity startGame(
        ...
        URI uri = ServletUriComponentsBuilder.fromCurrentRequest()
                .path("")
                .query("")
                .buildAndExpand(inputAction, gId,pId,inputLocation,quizId, inputRoundNumber,
        ...
        //        || !PlayingQuiz.isValidQuizId(quizId)
        ) {
            // 404
