...
public abstract class AbstractQasinoFlowDTO extends AbstractFlowDTO {
    ...
    public void setGameId(int gameId) {
        // this logic exists because the initiation of the creditquizRequest, which requires the request id, but is most
