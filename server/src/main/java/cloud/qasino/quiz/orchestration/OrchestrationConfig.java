...
import cloud.qasino.quiz.orchestration.OkAction;
...
import cloud.qasino.quiz.orchestration.interfaces.Expression;
...
import static cloud.qasino.quiz.event.EventEnum.ENTER_STATE;
...
*/
    ...
    public class StateConfig {
         ...
         *
         * @see cloud.qasino.quiz.orchestration.QasinoEventHandler
         */
...
/*        public StateConfig retryIfError() {
    ...
    public class EventConfig {
        ...
        public EventConfig transition(GameState nextState) {
            onState(nextState);
            perform((Class<? extends Action>) cloud.qasino.quiz.orchestration.OkAction.class).onResult(SUCCESS, nextState);
            return this;
        }
