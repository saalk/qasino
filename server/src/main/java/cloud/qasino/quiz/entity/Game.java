...
import cloud.qasino.quiz.entity.Result;
...
import cloud.qasino.quiz.entity.enums.quiz.PlayingQuiz;
...
public class Game {
    ...
    private List<cloud.qasino.quiz.entity.Quiz> quizzes = new ArrayList<>();
    ...
    public void shuffleGame(int jokers) {
        ...
        List<PlayingQuiz> playingQuizs = PlayingQuiz.newDeck(jokers);
        Collections.shuffle(playingQuizs);

        int i = 1;
        for (PlayingQuiz playingQuiz : playingQuizs) {
            cloud.qasino.quiz.entity.Quiz quiz = new Quiz(playingQuiz.getQuizId(), this, null, i++, Location.STOCK );
