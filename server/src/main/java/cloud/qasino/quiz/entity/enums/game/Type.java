...
import cloud.qasino.quiz.configuration.ContextType;
...
/**
 * <H1>QuizGame</H1> A selection of playingquiz gameDtos that can be selected to play. <p> More gameDtos will be
 * added in future.
 *
...
public enum Type implements LabeledEnum, ContextType {
    ...
    /**
     * HIGHLOW quizgame is a simple higher or lower guessing game. The dealer places one playingquiz
     * face-down in front of the player, then another playingquiz face-up for the players Hand. The player
     * guesses whether the value of the face-down playingquiz is higher or lower. <p> The player places his
    ...
    public static Set<Type> quizGamesListType = EnumSet.of(HIGHLOW);
