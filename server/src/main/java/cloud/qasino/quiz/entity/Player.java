...
public class Player {
    ...
    // HO: A Player holds one or more Quiz after dealing
    ...
    public Player(cloud.qasino.quiz.entity.User user, cloud.qasino.quiz.entity.Game game, Role role, int fiches, int seat) {
        this();
        this.user = user;
        this.role = role;
        this.game = game;
