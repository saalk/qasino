export const QUIZ_PUBLISH = 'publishQuiz';
export const QUIZ_DELETE = 'deleteQuiz';
export const QUIZ_EDIT = 'editQuiz';
export const QUIZ_EDIT_ADD_TAG = 'addTagToQuiz';
export const QUIZ_EDIT_REMOVE_TAG = 'removeTagFromQuiz';
export const QUIZ_RESET_STATE = 'resetQuizState';

export const CHECK_AUTH = 'checkAuth';
export const ANSWER_CREATE = 'createAnswer';
export const SCORE_DESTROY = 'destroyScore';
