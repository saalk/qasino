<template>
  <div class="flex justify-center full-height" :class="heightSize">
    <div class="row gt-sm">
      <div class="row">
        <div class="list">
          <label class="item" v-for="color in colors" :key="color.id">
      ...
      <div class="row">
        <div class="list fit">
          <label class="item" v-for="tone in colorTones" v-bind:key="tone">
            <div class="item-primary">
    ...
    <div class="row gt-sm">
      <div class="row ">
        <div class="list fit">
          <label class="item" v-for="bClass in buttonClasses" v-bind:key="bClass">
            <div class="item-primary">
      ...
      <div class="row">
        <div class="list">
          <label class="item" v-for="logoName in logos" v-bind:key="logoName">
            <div class="item-primary">
