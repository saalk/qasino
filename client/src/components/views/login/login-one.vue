<template>
  <div class="flex justify-center full-height" :class="heightSize">
    <div class="row gt-sm">
      <div class="row">
        <div class="list">
          <label v-for="color in colors" :key="color.id" class="item">
            <div class="item-primary">
              <q-radio v-model="bgColor" :val="color" />
            </div>
            <div class="item-content capitalize">{{ color }}</div>
          </label>
        </div>
      </div>
      <div class="row">
        <div class="list fit">
          <label v-for="tone in colorTones" :key="tone" class="item">
            <div class="item-primary">
              <q-radio v-model="toneColor" :val="tone" />
            </div>
            <div class="item-content capitalize">{{ tone }}</div>
          </label>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <div class="card-content bg-white">
        <div class="stacked-label">
          <input v-model="email" required class="full-width" type="email">
          <label>Email</label>
        </div>
        <div class="stacked-label">
          <input v-model="password" required class="full-width" type="password">
    ...
    <div class="row gt-sm">
      <div class="row">
        <div class="list fit">
          <label v-for="bClass in buttonClasses" :key="bClass" class="item">
            <div class="item-primary">
              <q-radio v-model="buttonClass" :val="bClass" />
            </div>
            <div class="item-content capitalize">{{ bClass }}</div>
          </label>
        </div>
      </div>
      <div class="row">
        <div class="list">
          <label v-for="logoName in logos" :key="logoName" class="item">
            <div class="item-primary">
              <q-radio v-model="logo" :val="logoName" />
            </div>
            <div class="item-content capitalize">{{ logoName }}</div>
          </label>
